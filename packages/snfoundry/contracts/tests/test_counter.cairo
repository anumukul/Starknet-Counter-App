use snforge_std::{declare,ContractClassTrait,spy_events,start_cheat_caller_address,stop_cheat_caller_address,set_balance,Token};
...
#[test]
#[should_panic(expected:"Counter can't be negative")]
...
#[test]
#[should_panic(expected:"User don't have enough balance")]
...
fn test_reset_counter_success(){
    ...
    assert!(erc_20.balance_of(user)==strk_to_fri(9),"Balance of user not updated correctly");

    assert!(erc_20.balance_of(owner_address())==strk_to_fri(1),"Balance of owner not updated correctly");
